type ProductListItemComponentProps = {
    product: { 
        id: number; 
        name: string; 
        price: number;
...
const ProductListItemComponent = ({product} : ProductListItemComponentProps) => {
  return (
    <div className="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
        <a href={`/products/${product.id}`}>
            <img className="hover:grow hover:shadow-lg" src={`${product.image}?q=80&fm=jpg&h=400&w=400&fit=crop` } />
